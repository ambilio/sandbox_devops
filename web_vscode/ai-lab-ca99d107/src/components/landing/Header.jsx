        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <nav className="flex items-center justify-between">
            ...
            >
              ...
              <span className="text-[10px] text-gray-500 tracking-widest uppercase">by Ambilio</span>
            </motion.div>
            ...
            >
              <Button
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white border-0 px-6"
              >
                Get Started
              </Button>
            </motion.div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <motion.div
                ...
                className="mt-6"
              >
                <Button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-6">
                  Get Started
                </Button>
              </motion.div>
            </div>
